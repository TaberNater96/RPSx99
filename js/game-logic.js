...
/*
 * Sets the moves and values for a specific player
 * Validates inputs and ensures total strength value does not exceed 99
 */
function setPlayerMoves(player, moveOneType, moveOneValue, moveTwoType,
  ...
  // Ensure total strength does not exceed the game limit of 99
  if ((moveOneValue + moveTwoValue + moveThreeValue) > 99) {
    return;
  }

  // Assign to global variables based on player identity
